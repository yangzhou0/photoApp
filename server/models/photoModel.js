...
let photoSchema = new mongoose.Schema({ description: String, imageUrl: String, originalName: String, hashtag: String, author: String, createdAt: Date, updatedAt: Date, likes:Number });
